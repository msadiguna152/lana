    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <section class="col-lg-12">
          ...
          <div class="card hero-dashboard shadow ">
            <h1 class="font-weight-bold">
              Selamat Datang 👋
            </h1>
            <h4>Sistem Informasi Persediaan ATK</h4>
            <p class="mb-0">
              Kelola dan pantau stok barang dengan mudah, cepat, dan terintegrasi.
            </p>
          ...
          <div class="row">
            <div class="col-lg-3 col-6">
              <div class="small-box glass gradient-info smallbox-modern animate">
                <div class="inner">
                  <h3 class="text-gloss counter" id="total_barang">0</h3>
                  <p class="text-gloss">Total Barang</p>
                </div>
                <div class="icon icon-animate">
            ...
            <div class="col-lg-3 col-6">
              <div class="small-box glass gradient-success smallbox-modern animate">
                <div class="inner">
                  <h3 class="text-gloss counter" id="barang_masuk">0</h3>
                  <p class="text-gloss">Barang Masuk</p>
                </div>
                <div class="icon icon-animate">
            ...
            <div class="col-lg-3 col-6">
              <div class="small-box glass gradient-danger smallbox-modern animate">
                <div class="inner">
                  <h3 class="text-gloss counter" id="barang_keluar">0</h3>
                  <p class="text-gloss">Barang Keluar</p>
                </div>
                <div class="icon icon-animate">
            ...
            <div class="col-lg-3 col-6">
              <div class="small-box glass gradient-warning smallbox-modern animate">
                <div class="inner">
                  <h3 class="text-gloss counter" id="stok_menipis">0</h3>
                  <p class="text-gloss">Stok Menipis</p>
                </div>
                <div class="icon icon-animate">
