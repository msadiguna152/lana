  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-info"><marquee><b>Sistem Informasi Manajemen Barang</b></marquee></a>
        </li>
      </ul>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right">
            ...
            <?php foreach ($jnotif->result() as $dtnotif) : ?>
              ...
              <a href="<?= base_url();?>Permintaan/update/<?= $dtnotif->id_barang_keluar; ?>" class="dropdown-item">
    ...
    <aside class="main-sidebar elevation-4 sidebar-light-info">
      <a href="" class="brand-link bg-info text-center">
        ...
        <span class="brand-text font-weight-light"><b>S I M B</b></span>
      </a>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item <?= ($menu == "Laporan" OR $menu == "Laporan2") ? "menu-open" : "";?>">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="<?= base_url()?>Laporan/LPLPO" class="nav-link <?= ($menu == "Laporan2") ? "active" : "";?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>LPLPO</p>
                  </a>
                </li>
            ...
            <li class="nav-item <?= ($menu == "Pengguna" OR $menu == "Satuan" OR $menu == "Jabatan" OR $menu == "Pangkat") ? "menu-open" : "";?>">
              <a href="#" class="nav-link <?= ($menu == "Pengguna" OR $menu == "Satuan" OR $menu == "Jabatan" OR $menu == "Pangkat") ? "active" : "";?>">
