          ...
          <div class="row">
            <section class="col-lg-12">
              <div class="card">
                ...
                <form role="form" action="<?= site_url('Bidang/update_proses');?>" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">

                      <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="form-group">
                          <label for="nama_bidang">Nama Seksi</label>
                          <input type="text" class="form-control date" id="" name="nama_bidang" value="<?= $dtbidang['nama_bidang']; ?>" required="">
                          <input type="text" hidden="" name="id_bidang" value="<?= $dtbidang['id_bidang']; ?>" required="">
                        </div>
                      </div>
