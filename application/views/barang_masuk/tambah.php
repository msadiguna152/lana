                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-6 col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" readonly name="no_barang_masuk" autofocus value="<?= $kode; ?>" placeholder="Masukan No" required="">
                        </div>

                        <div class="form-group">
                          <label for="no_bukti">No. Bukti</label>
                          <input type="text" class="form-control" name="no_bukti" placeholder="Masukan No. Bukti" required="">
                        </div>
                      ...
                      <div class="col-xl-6 col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="tanggal_barang_masuk" placeholder="Masukan Tanggal Barang Masuk" required="">
                        </div>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                  <input type="number" class="form-control" id="stok_barang_masuk" name="stok_barang_masuk[]" maxlength="6" placeholder="Masukan Stok Masuk" required>
                                </td>
                                <!-- <td style="text-align: center; vertical-align: middle;">
                                  <input type="number" class="form-control" id="harga_barang_masuk" name="harga_barang_masuk[]" maxlength="9" placeholder="Masukan Harga" required>
                                </td> -->
                              </tr>
                            </tbody>
                            <tfoot>
