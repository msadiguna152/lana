    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <h5 class="m-0 text-info">Rincian Data Pengeluaran Obat / BMHP</h5>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                      ...
                      <?php } elseif ($dtbarang_keluar['keluar_karena']=="Permintaan Non PKM") { ?>
                        ...
                        <div class="form-group asal_permintaan">
                          ...
                          <input type="text" class="form-control" value="<?= $dtbarang_keluar['asal_permintaan']; ?>" readonly>
                        </div>

                      <?php } else { ?>
                        <div class="form-group no_berita_acara">
                          <label for="no_berita_acara">No. Berita Acara</label>
                          <input type="text" class="form-control" value="<?= $dtbarang_keluar['no_berita_acara']; ?>" readonly>
                        </div>
                      <?php }; ?>
