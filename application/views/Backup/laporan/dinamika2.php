    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <h5 class="m-0 text-info">Dinamika Logistik obat & Alkes <?= $bulan_tahun!=NULL ? '('.format_indo2($bulan_tahun).')' :'';?></h5>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card-header">
                  <div class="row">
                    <div class="col-lg-2 col-md-6 col-sm-12 mb-1">
                      <a href="<?= site_url('Laporan/cetak_dinamika')?>" class="btn btn-block btn-info">Cetak</a>
                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-12 mb-1">
                    ...
                    <table id="" width="100%" class="table table-bordered table-hover">
                      ...
                      <tbody style="text-align: left; vertical-align: top;">
                        ...
                        foreach ($laporan->result() as $data) :
                          ...
                          <tr>
                            <?php
                            $source2 = $this->db->query("SELECT * from barang where id_barang = '$data->id_barang'");
