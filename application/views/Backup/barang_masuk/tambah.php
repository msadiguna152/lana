                            ...
                            <tbody>
                              <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                  <input type="text" class="form-control" id="no_batch" style="width: 150px;" name="no_batch[]" placeholder="Masukan No. Batch"  required="">
                                </td>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                  <input type="number" class="form-control" id="stok_barang_masuk" style="width: 150px;" name="stok_barang_masuk[]" maxlength="6" placeholder="Masukan Stok Masuk" required>
                                </td>
                                <td style="text-align: center; vertical-align: middle;">
                                  <input type="number" class="form-control" id="harga_barang_masuk" style="width: 150px;" name="harga_barang_masuk[]" maxlength="9" placeholder="Masukan Harga" required>
                                </td>
                                <td style="text-align: center; vertical-align: middle;">
                                  <input type="month" class="form-control" id="expire_date" name="expire_date[]" placeholder="Masukan Tanggal Expired Date" required>
                                </td>
                              </tr>
                            </tbody>
                          </table>
