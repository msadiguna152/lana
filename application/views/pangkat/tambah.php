    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <h5 class="m-0 text-info">Tambah Data Pangkat / Golongan</h5>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <section class="col-lg-12">
              <div class="card">
                ...
                <form role="form" action="<?= site_url('Pangkat/insert_proses');?>" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nama_pangkat" placeholder="Masukan Nama Pangkat / Golongan" required="">
                        </div>
                      </div>
