          ...
          <div class="row">
            <section class="col-lg-12">
              <div class="card">
                ...
                <form role="form" action="<?= site_url('Pengguna/insert_proses');?>" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-xl-6 col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control select2bs4" style="width: 100%;" name="level" data-placeholder="Pilih Level" required="">
                        ...
                        <div class="form-group">
                          ...
                          <input type="file" accept="image/*" class="form-control" name="foto_pengguna" required="">
                        </div>

                        <div class="form-group">
                          <label for="status_pengguna">Status Pengguna</label>
                          <select class="form-control select2bs4" style="width: 100%;" name="status_pengguna" data-placeholder="Pilih Status Pengguna" required="">
